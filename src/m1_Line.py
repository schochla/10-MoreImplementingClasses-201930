...
class Line(object):
    ...
    def slope(self):
        ...
        distance_x = (self.start.x - self.end.x)
        distance_y = (self.start.y - self.end.y)
        if distance_x is 0:
            slope = math.inf
        else:
    ...
    def line_plus(self, other_line):
        ...
        new_line = Line(Point(new_start_x, new_start_y), Point(new_end_x, new_end_y))
        return new_line
    ...
    def reset(self):
        ...
        og_start = Line(self.start, self.end)
        return og_start
